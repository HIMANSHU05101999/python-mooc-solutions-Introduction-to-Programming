...
def cheaper_properties(properties, obj):
    return [(prop,obj.square_meters*obj.price_per_sqm - prop.square_meters*prop.price_per_sqm) for prop in properties if prop.square_meters*prop.price_per_sqm<obj.square_meters*obj.price_per_sqm]
